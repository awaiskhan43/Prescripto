    ...
    <div>
      ...
      <div>
        {doctors.slice(0,3).map((item,index)=>(
          <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap6 py-2 border-b' key={index}>
             <div>
             ...
             <div className='flex-1 text-sm text-zinc-600'>
              ...
              <p className='text-sm mt-1'><span className='text-sm text-neutral-700 font-medium'>Date & Time:</span> 03, Oct, 2024 | 10:30 PM</p>
             </div>
             <div></div>
